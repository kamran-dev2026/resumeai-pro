...
import { ResumeData, ResumeStep, ResumeTemplate, Experience, Education } from '../types';
import {
  generateSummary,
        ...
        {photo ? (
          <div className="group relative">
            <img
              src={photo}
              alt="Profile"
              className="h-28 w-28 rounded-full border-4 border-slate-700 object-cover shadow-lg shadow-primary-500/10 transition-all group-hover:border-primary-500/50"
            />
            <button
              onClick={removePhoto}
              className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-red-500 text-white shadow-md transition-transform hover:scale-110"
            >
          ...
          <button
            ...
            className="flex h-28 w-28 flex-col items-center justify-center rounded-full border-2 border-dashed border-slate-600 bg-slate-800/50 text-slate-400 transition-all hover:border-primary-500/50 hover:bg-slate-800 hover:text-primary-400"
          >
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6 sm:p-8">
      <SectionTitle
        ...
        subtitle="Let's start with your basic details and a profile photo"
      />

      {/* Photo Upload */}
      <div className="mb-6 flex justify-center">
        <PhotoUpload photo={data.photo} onUpdate={onUpdate} />
      </div>
